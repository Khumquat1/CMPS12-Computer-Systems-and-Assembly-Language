...
REGSISTERS            ; Register initialization and function
...
MAINLOOP 
   LEA R0, PROMPT     ; Load PROMPT pointer into R0
...
GREETING .STRINGZ "Welcome, cool kid! This is a Caesar Cipher program.\n"
PROMPT .STRINGZ "(E)n/(D)ecrypt or e(X)it\n"
CIPHERSTR .STRINGZ "\nCipher (1-25)\n"
...
ADD R3, R3, 1 ;R3 += 1
    ...
    RESETLOOP
    LEA R2, ARRAY ;ARRAY POINTER INTO R2
    ADD R2, R2, R1 ;R2 += R1
    STR R4, R2, 0 ;STORE R0 VALUE AT R3 ADDRESS
    ADD R1, R1, 1 ;R1 += 1
    ADD R5, R1, R3 ;R5 = R1 + R3
    BRn RESETLOOP
